...
$("document").ready(function () {
  ...
  $(window).resize(function () {
    ...
    $("#b11").animate({ top: 240, left: vw - 425 }, 500);
    $("#b22").animate({ top: 240, left: vw - 350 }, 500);
    $("#b33").animate({ top: 240, left: vw - 275 }, 500);
    ...
    $("#b100").animate({ top: 240, left: vw + 325 }, 500);
  });
  ...
  $("#bannar_coming").click(function () {
    ...
    $(".img1").addClass("img1-come");
    $(".img2").addClass("img2-come");
    $(this)
      .fadeOut("slow")
      .delay(6000)
      .promise()
